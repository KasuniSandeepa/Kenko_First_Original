...
@WebServlet("/SignUpOtpVerificationServlet")
public class SignUpOtpVerificationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SubmittedOtp.equals(SentOtp)) {
                //send forward
                response.sendRedirect("ProfileAdd.jsp?VerifiedNumber="
                        .concat(SentNumber));
            } else {
                //send back
