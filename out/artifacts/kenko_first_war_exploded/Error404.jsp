...
<head>
    ...
    <title>Page Not Found - Kenko 1st Agri Business</title>
                        ...
                        <div class="col-md-12">
                            <div class="p-4">
                                ...
                                <div class="text-center pt-4">
                                    <h1 class="text-60 text-danger font-weight-bold">404</h1>
                                    <p class="text-36 subheading mb-4 text-danger font-weight-bold">
                                        <span id="lblError404Title">Error!</span>
                                    </p>
                                    <p class="mb-5 text-muted text-18">
                                        <span id="lblError404Body">
                                            Sorry! The page you were looking for doesn't exist.
                                        </span>
                                    </p>
                                    <a class="btn btn-primary btn-block" href="Profile.jsp" id="lblError404Footer">
